...
var (
	...
	UploadFile                    = make(chan string, 1)
	ClientNotificationChannel     = make(chan bool, 1) // 客户端通知通道
	FlagInFalse                   string
	Config                        CONFIG
	WallpaperOrUploadFileFlag     bool // true则为上传文件False则为更换壁纸
	FlagBool                      bool
	ObtainingOnlineNumberOfPeople []SessionInfo
	Mu                            sync.Mutex
)

var VarusSpec string = `# -*- mode: python ; coding: utf-8 -*-
